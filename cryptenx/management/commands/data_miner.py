...
# TODO: Add support for gathering data on other currencies
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.get_timestamps()
        # Params 'periods' indicates a 3 minute period (60 seconds * 3)
        # This setting will call data in 3 minute intervals
        params = {
        ...
        if resp.ok:
            ...
            try:
                ...
                raise CommandError("Error saving data.")
        else:
            raise CommandError("Invalid API request.")
